...
//se realiza una peticion para eliminar la incidencia en base a su nombre
    ...
    fetch(`http://10.200.4.242:1339/api/Incidencias/${nom_inci}`,{
        method:'DELETE',
        body:JSON.stringify(),
        headers:{
...
function edit_inci(id_inci){
    ...
    if(nom_inci=="" || des_inci=="" || area_inci==""){
        ...
        fetch('http://10.200.4.242:1339/api/Incidencias/edit_inci/',{
            method:'PUT',
...
function datos_incidencia(value_inci){
    ...
    fetch(`http://10.200.4.242:1339/api/Incidencias/espec/${value_inci}`,{
        method:'GET',
        body:JSON.stringify(),
        headers:{
            'Content-Type':'application/json'
...
function buscar_dispo(nom_problem){
    ...
    fetch(`http://10.200.4.242:1339/api/Incidencias/dispo/${dispo}`,{
        method:'GET',
        body:JSON.stringify(),
        headers:{
            'Content-Type':'application/json'
...
function buscar_inci_area(nom_incidencia,incidencia,tarea,div){
    ...
    if(buscar_inci==""){
        ...
        fetch(`http://10.200.4.242:1339/api/Incidencias/Areas/${buscar_inci}`,{
        method:'GET',
        body:JSON.stringify(),
        headers:{
            'Content-Type':'application/json'
