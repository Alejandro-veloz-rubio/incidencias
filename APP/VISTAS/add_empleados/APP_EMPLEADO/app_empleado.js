...
function eliminar_empleado(){
    ...
    fetch(`http://10.200.4.242:1339/api/Empleados/${id_em_delete}`,{
        method:'DELETE',
        body:JSON.stringify(),
        headers:{
    ...
    if(apellido_paterno=="" || apellido_materno=="" || nombres=="" || area_asignada=="" || puesto=="" || num_nomina==""){
        ...
        alert('Todos los campos son obligatorios')
         ...
         //todos los datos obtenidos los pasamos a formato JSON y algunos datos los convertimos de string a enteros
            ...
            fetch('http://10.200.4.242:1339/api/Empleados/edit',{
                method:'PUT',
...
function datos_empleado(id_em){
    ...
    fetch(`http://10.200.4.242:1339/api/Empleados/edit_search/${id}`,{
        method:'GET',
        body:JSON.stringify(),
        headers:{
            'Content-Type':'application/json'
...
btnagregarempleado.addEventListener('click',()=>{
    ...
    if(apellido_paterno=="" || apellido_materno=="" || nombres=="" || area_asignada=="" || puesto=="" || num_nomina==""){
        ...
        fetch('http://10.200.4.242:1339/api/Empleados',{
            method:'POST',
...
function buscar_disponi(id_dispo){
    ...
    fetch(`http://10.200.4.242:1339/api/Empleados/dipo_em/${id_em}`,{
        method:'GET',
        body:JSON.stringify(),
        headers:{
            'Content-Type':'application/json'
